---
title: "Biodiversity in U.S. National Parks for Github"
...
<br  />
Plotting the locations of the continential national parks and their sizes:
```{r}
...
```
This map reveals that most continental parks are under 1 million square acres in size. A few exceptionally large parks include Everglades, Yellowstone, Death Valley, Glacier, and Olympic.
<br  />
<br  />
